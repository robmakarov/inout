...
describe('estimateScheduleSkewFromArrivals', () => {
  it('recovers ~200 ms stall when all beeps are present', () => {
    ...
    const est = estimateScheduleSkewFromArrivals(arrivals)
