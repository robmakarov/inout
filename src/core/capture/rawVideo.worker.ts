...
/** The AVC profile/level ladder — owned by avcCodecs.ts, shared with the
 *  throughput meter so the meter can be configured at the take's own size. */
const CODEC_CANDIDATES = AVC_CODEC_CANDIDATES
